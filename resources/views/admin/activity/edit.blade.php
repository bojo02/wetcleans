        ...
        <div class="col-lg-12">
           ...
           <div class="list-group">
            ...
            <form action="{{route('admin.notification.update', ['notification' => $notification->id])}}" method="POST" enctype="multipart/form-data">
                ...
                <a onclick="return confirm('Сигурни ли сте?')" style="float:right;" href="{{route('admin.activity.delete', ['notification' => $notification->id])}}" class="btn btn-danger">Изтрий</a>
            </form>
